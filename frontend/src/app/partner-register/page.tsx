    ...
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <nav className="bg-[#2D2D2D] text-white py-4 px-8 flex justify-between items-center whitespace-nowrap">
        ...
        <div className="flex space-x-8 text-lg">
          ...
          <Link href="/partner-login" className="hover:text-gray-300">Partner Portal</Link>
        </div>
      </nav>
      ...
      <main className="flex-grow flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 relative min-h-[600px] bg-[#1E1E1E]">
          ...
          <div className="absolute inset-0 z-20 flex flex-col justify-center items-start p-12 text-white">
            <h1 className="text-5xl font-semibold mb-4 drop-shadow-md">Empower Your Kitchen.</h1>
        ...
        <div className="md:w-1/2 bg-[#FCFAF8] flex justify-center items-center p-8">
          <div className="bg-white border-2 border-gray-400 rounded-lg p-10 w-full max-w-md shadow-sm">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-medium text-gray-800">Partner Portal</h2>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                <label className="block text-xs text-gray-600 mb-1">Restaurant Name</label>
                <input
                  id="partner-register-display-name"
                  type="text"
                  value={displayName}
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-400 mt-1">e.g. 81234567890 (without leading 0)</p>
              </div>
              ...
              <div className="pt-2">
                <Link href="/partner-login" className="text-xs text-[#0099FF] hover:underline">
              ...
              <div className="pt-4 flex justify-center">
                <button
                  id="partner-register-submit"
                  type="submit"
                  disabled={loading}
                  className="bg-[#C1272D] text-white px-12 py-2 text-sm rounded-md hover:bg-red-800 transition-colors disabled:opacity-60"
                >
      ...
      <footer className="bg-[#2D2D2D] text-white py-12 px-8 flex flex-col md:flex-row justify-between text-sm w-full">
        ...
        <div className="grid grid-cols-3 gap-8 md:w-2/4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-xs">
              <li><Link href="/partner-login" className="hover:text-white">Partner Login</Link></li>
              <li><Link href="/partner-register" className="hover:text-white">Register Restaurant</Link></li>
